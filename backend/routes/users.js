...
api.post('/register', UserController.postNewUser);
...
api.get('/counters/:id?', middleware_auth.ensureAuth, UserController.getUsersCounter);
...
api.get('/get-image-user/:imageFile', middleware_auth.ensureAuth, UserController.getFiles);
